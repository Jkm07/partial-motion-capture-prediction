...
from packages.bvhConverter import bvh_converter
...
def get_hierarchy(filename = "./packages/bvhConverter/data/amass_hierarchy"):
    with open(filename) as f:
        return bvh_converter.get_hierarchy(f)